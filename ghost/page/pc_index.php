...
$menu_right .= '<a class="ghost_control">
<span class="poi-icon '.$cms_group['ghost_pc_cms_icon'].'" aria-hidden="true"></span> 
<span class="ghost_control_text">'.get_cat_name($cms_group['ghost_pc_cms_id']).'</span>
</a>';
}}
