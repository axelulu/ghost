...
require( '../../../../../wp-load.php' );
global $current_user;
$useravatar_security_nonce = wp_create_nonce('ghostavatar-' . $current_user->ID);
$useremail_security_nonce = wp_create_nonce('ghostemail-' . $current_user->ID);
$userpwd_security_nonce = wp_create_nonce('ghostpwd-' . $current_user->ID);
$userswitch_security_nonce = wp_create_nonce('ghostswitch-' . $current_user->ID);
...
<div class="ghost_setting_content">
    <div class="ghost_setting_content_container">
        <fieldset class="ghost_setting_content_item">
            ...
            <div class="ghost_setting_content_item_content">
                <div class="ghost_setting_content_preface">
                    <p>修改头像需要 <?php echo ghost_get_option('avatar_credit_msg') ?> 个喵爪哦！</p>
                </div>
                <div class="ghost_setting_content_my_avatar">
                    <div class="ghost_setting_content_my_avatar_img">
                        <img style="width: 100px;height: 100px;" src="<?php echo get_user_meta($current_user->ID,'ghost_user_avatar',true) ?>" alt="avatar" class="ghost_setting_content_avatar_img" width="100" height="100"></div>
                    <label class="ghost_setting_content_my_avatar_upload-btn">
                        ...
                        <input style="display:none" type="file" name="my_avatar" id="my_avatar" accept=".jpg, .gif, .png" resetonclick="true" data-nonce="<?php echo $useravatar_security_nonce; ?>"></label>
                </div>
            </div>
        </fieldset>
        <fieldset class="ghost_setting_content_item">
                        ...
                        <div class="clearfix ">
                            ...
                            <div class="col-lg-10 float-right">
                                <div class="ghost_setting_content_preface_item_content">
                                    <input type="name" class="ghost_setting_content_preface_control" required="" placeholder="昵称" title="昵称" value="<?php echo $current_user->nickname ?>"></div>
                            </div>
                        </div>
                    </div>
                    <div class="ghost_setting_content_preface_item">
                        <div class="clearfix ">
                            ...
                            <div class="col-lg-10 float-right">
                                <div class="ghost_setting_content_preface_item_content">
                                    <textarea type="dec" class="ghost_setting_content_preface_control" rows="5" placeholder="描述" title="描述" value="描述"><?php echo $current_user->description ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <fieldset class="ghost_setting_content_item">
            ...
            <div class="ghost_setting_content_item_content">
                <div class="ghost_setting_content_preface">
                    <p>修改账号邮箱，需要 <?php echo ghost_get_option('myemail_credit_msg') ?> 个喵爪哦！</p>
                </div>
                <form action="javascript:;">
                    <div class="ghost_setting_content_preface_item">
                        <div class="clearfix">
                            ...
                            <div class="col-lg-10 float-right">
                                <div class="ghost_setting_content_preface_item_content">
                                    <input type="email" class="ghost_setting_content_preface_control" placeholder="邮箱" title="邮箱" required="" value="<?php echo $current_user->user_email ?>"></div>
                            </div>
                        </div>
                    </div>
                    <div class="ghost_setting_content_preface_item">
                    ...
                    <div class="ghost_setting_content_preface_item">
                        <div class="clearfix">
                            ...
                            <div class="col-lg-10 float-right">
                                <div class="ghost_setting_content_preface_item_content">
                                    <button type="submit" data-emailnonce="<?php echo $useremail_security_nonce; ?>" class="my_email_msg ghost_setting_content_btn_success">
                                        <span class="poi-icon fa-check fas fa-fw" aria-hidden="true"></span>
        ...
        <fieldset class="ghost_setting_content_item">
            ...
            <div class="ghost_setting_content_item__content is-expand">
                <div class="ghost_setting_content_preface">
                    <p>修改密码，需要 <?php echo ghost_get_option('pwd_credit_msg') ?> 个喵爪哦！</p>
                </div>
                <form action="javascript:;">
                    <div class="ghost_setting_content_preface_item">
                        <div class="clearfix">
                    ...
                    <div class="ghost_setting_content_preface_item">
                        <div class="clearfix">
                            ...
                            <div class="col-lg-10 float-right">
                                <div class="ghost_setting_content_preface_item_content">
                                    <button type="submit" data-pwdnonce="<?php echo $userpwd_security_nonce; ?>" class="my_pwd_msg ghost_setting_content_btn_success">
                                        <span class="poi-icon fa-check fas fa-fw" aria-hidden="true"></span>
                ...
                <form action="javascript:;">
													...
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='show_ip' class="ghost_show_ip checkbox" <?php if(get_user_meta($current_user->ID,'show_ip',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='login_email_msg' class="ghost_login_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'login_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='forget_email_msg' class="ghost_forget_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'forget_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='pwd_email_msg' class="ghost_pwd_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'pwd_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='myemail_email_msg' class="ghost_myemail_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'myemail_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='avatar_email_msg' class="ghost_avatar_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'avatar_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='comment_email_msg' class="ghost_comment_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'comment_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='post_email_msg' class="ghost_post_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'post_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='buy_download_link' class="ghost_buy_download_link checkbox" <?php if(get_user_meta($current_user->ID,'buy_download_link',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                            ...
                            <div class="col-lg-8 float-right">
                                <div class="ghost_setting_content_preface_item_content">
													<div class="toggle-button-cover">
													  <div class="button-cover">
														<div class="button r" id="button-3">
														  <input value='yes' type="checkbox" name='message_email_msg' class="ghost_message_email_msg checkbox" <?php if(get_user_meta($current_user->ID,'message_email_msg',true)=='yes') echo 'checked'; ?>>
														  <div class="knobs"></div>
														  <div class="layer"></div>
														</div>
													  </div>
                    ...
                    <div class="ghost_setting_content_preface_item">
                        <div class="clearfix">
                            ...
                            <div class="col-lg-10 float-right">
                                <div class="ghost_setting_content_preface_item_content">
                                    <button type="submit" data-switchnonce="<?php echo $userswitch_security_nonce; ?>" class="my_switch_msg ghost_setting_content_btn_success">
                                        <span class="poi-icon fa-check fas fa-fw" aria-hidden="true"></span>
