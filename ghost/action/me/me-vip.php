...
<div class="ghost_guajian_shop_title">挂件购买</div>
    <?php foreach(ghost_get_option('ghost_shop_guajian_vip') as $value) {?>
    <div class="ghost_shops_item">
        <a class="ghost_shop_item_link <?php echo ghost_shop_item_link_submit_vip($user_id); ?> clearfix" title="<?php echo $value['ghost_shop_guajian_name'] ?>">
