...
if( ! class_exists( 'GHOST_Field_color' ) ) {
class GHOST_Field_color extends GHOST_Fields {
...
echo '<input type="text" name="'. $this->field_name() .'" value="'. $this->value .'" class="ghost-panel-color"'. $default_attr . $this->field_attributes() .'/>';
