...
if( ! class_exists( 'GHOST_Field_wp_editor' ) ) {
class GHOST_Field_wp_editor extends GHOST_Fields {
...
echo ( csf_wp_editor_api() ) ? '<div class="ghost-panel-wp-editor" data-editor-settings="'. esc_attr( wp_json_encode( $editor_settings ) ) .'">' : '';
