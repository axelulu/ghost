...
if( ! class_exists( 'GHOST_Field_spacing' ) ) {
class GHOST_Field_spacing extends GHOST_Fields {
...
echo ( ! empty( $args['all_text'] ) ) ? '<span class="ghost-panel--label ghost-panel--label-icon">'. $args['all_text'] .'</span>' : '';
