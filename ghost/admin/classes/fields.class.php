...
if( ! class_exists( 'GHOST_Fields' ) ) {
abstract class GHOST_Fields {
...
$output  = ( ! empty( $this->field['desc'] ) ) ? '<p class="ghost-panel-text-desc">'. $this->field['desc'] .'</p>' : '';
$output .= ( ! empty( $this->field['after'] ) ) ? $this->field['after'] : '';
$output .= ( ! empty( $this->field['help'] ) ) ? '<span class="ghost-panel-help"><span class="ghost-panel-help-text">'. $this->field['help'] .'</span><span class="fa fa-question-circle"></span></span>' : '';
$output .= ( ! empty( $this->field['_error'] ) ) ? '<p class="ghost-panel-text-error">'. $this->field['_error'] .'</p>' : '';
...
$options[$category->term_id] = $category->name.' <span>('.urldecode($category->slug).')</span>';
}
}
